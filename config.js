...
module.exports = {
    ...
    SESSION_ID: process.env.SESSION_ID || "MEGALODON~MD~a5A2UBAZ#jTSH9vIwUu7bHVZ6J3zwtAb648xfX5J8EyMr2VGxlxk",  // Your bot's session ID (keep it secure)
    ...
    OWNER_NUMBER: process.env.OWNER_NUMBER || "2250545290154",  // Owner's WhatsApp number
